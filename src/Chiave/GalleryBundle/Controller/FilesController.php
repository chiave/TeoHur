...
class FilesController extends Controller
{
     ...
     * Lists all files.
     *
     * @Route("/admin/files", name="chiave_gallery_files")
     * @Method("GET")
    ...
    /**
     * @Route("/admin/files/create", name="chiave_gallery_files_create")
     * @Method("POST")
     * @Security("has_role('ROLE_ADMIN')")
     * @Template("ChiaveGalleryBundle:Files:update.html.twig")
     */
    ...
    /**
     * @Route("/admin/files/new", name="chiave_gallery_files_new")
     * @Method("GET")
     * @Security("has_role('ROLE_ADMIN')")
     * @Template("ChiaveGalleryBundle:Files:update.html.twig")
     */
     ...
     *
     * @Route("/admin/files/{id}/edit", name="chiave_gallery_files_edit")
     * @Method("GET")
     * @Security("has_role('ROLE_ADMIN')")
     * @Template("ChiaveGalleryBundle:Files:update.html.twig")
     */
     ...
     *
     * @Route("/admin/files/{id}/update", name="chiave_gallery_files_update")
     * @Method("POST")
     * @Security("has_role('ROLE_ADMIN')")
     * @Template("ChiaveGalleryBundle:Files:update.html.twig")
     */
     ...
     * Deletes file.
     *
     * @Route("/admin/files/{id}/delete", name="chiave_gallery_files_delete")
     * @Method("POST")
     * @Security("has_role('ROLE_ADMIN')")
     */
